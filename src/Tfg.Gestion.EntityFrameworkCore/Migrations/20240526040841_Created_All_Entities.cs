...
{
    /// <inheritdoc />
    public partial class Created_All_Entities : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SalesHistories_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RawMaterialDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RawMaterialDetails_Dishes_DishId",
                        column: x => x.DishId,
                        principalTable: "Dishes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RawMaterialDetails_RawMaterials_RawMaterialId",
                        column: x => x.RawMaterialId,
                        principalTable: "RawMaterials",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RawMaterialDetails_DishId",
                table: "RawMaterialDetails",
                column: "DishId");

            migrationBuilder.CreateIndex(
                name: "IX_RawMaterialDetails_RawMaterialId",
                table: "RawMaterialDetails",
                column: "RawMaterialId");

            migrationBuilder.CreateIndex(
                name: "IX_RawMaterials_ProductProviderId",
                table: "RawMaterials",
                column: "ProductProviderId");

            migrationBuilder.CreateIndex(
                name: "IX_SalesHistories_OrderId",
